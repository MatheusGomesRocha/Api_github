                                    ...
                                    {view == 'Overview' ?
                                        ...
                                        <div className={"arrayDivRepos"}>
                                            <div className={"inputAndBtns"}>
                                                <input onKeyPress={handleKey} onChange={reposSearch}
                                                        ...
                                                        <div className={"reposSideDiv"}>
                                                            ...
                                                            <div className={"languageDiv"}>
                                                                ...
                                                                <div className={"starDiv"}>
                                                                    <StarIcon/>
                                                                    <span
                                                                        className={"starText"}>{repo.stargazers_count}</span>
                                                                </div>
                                                        ...
                                                        <div className={"repositories"}>
                                                            ...
                                                            <div className={"reposSideDiv"}>
                                                                <a target={"_blank"} href={item.html_url}
                                                                   className={"link"}>{item.name}</a>
                                                                <span
                                                                    className={"description"}>{item.description}</span>
                                                                ...
                                                                <div className={"languageDiv"}>
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <span
                                                                            className={"language"}>{item.language}</span>
                                                                    </>
                                                                    }
                                                                    <div className={"starDiv"}>
                                                                        <StarIcon/>
